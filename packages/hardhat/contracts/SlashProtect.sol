...
// File: contracts/SlashProtect.sol
...
contract SlashProtect is Ownable {
    ...
    constructor(ISlashToken _slash, uint256 _lockDuration, bool _depositsEnabled) {
        slash = _slash;
    ...
    function deposit(uint256 _amount) external {
        ...
        IERC20(address(slash)).safeTransferFrom(address(msg.sender), address(this), _amount);
        slash.burn(_amount);
    ...
    function withdraw(uint256 _amount) external {
        ...
        user.amount -= _amount;
        totalStaked -= _amount;
        slash.mint(address(msg.sender), _amount);
